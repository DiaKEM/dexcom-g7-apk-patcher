...
.method public constructor <init>(Lorg/spongycastle/crypto/StreamCipher;III)V
    ...
    iput-object v2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->availableSpecs:[Ljava/lang/Class;
...
.method private varargs ࡦࡧ࡯(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-super {p0, p1, p2}, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->ࡩࡥᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v8, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->cipher:Lorg/spongycastle/crypto/StreamCipher;
    ...
    const-string v3, "mttqww$g{mnn|+\u0001|}/\u0004y\u0002\u0006\t5|\u0007\u000b9\u0004\n\r\u0013\u0013M"
    ...
    const-string v3, "JGS\u000bW\u0002TUONLNOyFG;;t"
    ...
    instance-of v0, v5, Ljavax/crypto/SecretKey;

    if-eqz v0, :cond_1f

    instance-of v0, v5, Lorg/spongycastle/jcajce/PKCS12Key;

    if-eqz v0, :cond_10

    check-cast v5, Lorg/spongycastle/jcajce/PKCS12Key;
    ...
    instance-of v0, v5, Lorg/spongycastle/jcajce/PKCS12KeyWithParameters;
    ...
    :cond_c
    invoke-virtual {v5}, Lorg/spongycastle/jcajce/PKCS12Key;->getEncoded()[B

    move-result-object v5

    const/4 v6, 0x2

    iget v7, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->digest:I

    iget v8, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->keySizeInBits:I

    iget v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ivLength:I

    mul-int/lit8 v9, v0, 0x8

    iget-object v10, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->pbeSpec:Ljavax/crypto/spec/PBEParameterSpec;
    ...
    invoke-static/range {v5 .. v11}, Lorg/spongycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEParameters([BIIIILjava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Lorg/spongycastle/crypto/CipherParameters;
    ...
    invoke-direct {v0, v6, v1}, Lorg/spongycastle/crypto/params/ParametersWithIV;-><init>(Lorg/spongycastle/crypto/CipherParameters;[B)V
    ...
    :cond_10
    instance-of v0, v5, Lorg/spongycastle/jcajce/provider/symmetric/util/BCPBEKey;
    ...
    :cond_12
    instance-of v0, v3, Ljavax/crypto/spec/PBEParameterSpec;
    ...
    invoke-static {v5, v3, v0}, Lorg/spongycastle/jcajce/provider/symmetric/util/PBE$Util;->makePBEParameters(Lorg/spongycastle/jcajce/provider/symmetric/util/BCPBEKey;Ljava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Lorg/spongycastle/crypto/CipherParameters;
    ...
    invoke-direct {v6, v1, v0}, Lorg/spongycastle/crypto/params/ParametersWithIV;-><init>(Lorg/spongycastle/crypto/CipherParameters;[B)V
    ...
    invoke-interface {v1, v0, v6}, Lorg/spongycastle/crypto/StreamCipher;->init(ZLorg/spongycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {v0, v3, v6}, Lorg/spongycastle/crypto/StreamCipher;->init(ZLorg/spongycastle/crypto/CipherParameters;)V
    ...
    const-string v3, "\u0010\u0010?gs<\u000f\u007f\u000e8\u000f~z\u00033\u0002\u007fu/s\u0006|pm}mk"
    ...
    const-string v3, ";SJ\u000cG\u0007\u001d[yuhR-YqUd=X\u00109sw\r\u0018OtmJyD%R5j\u001dN*"
    ...
    const-string v2, "\u000e:6?C;G<BuI=JODNBQ~A\u00012%)\u0005QLa"
    ...
    const-string v4, "xrptv\u007fw*{m\u007fo|u\u0006w\u00064\n\u0010\u0008}G"
    ...
    const-string v4, "\u007fLR_X5;,\u0001q{\u0012P\u0014Vh1jGS\u000f\u000c\u0008 kji$1?M_ (\u001a*l5"
    ...
    :try_start_4
    invoke-virtual {p0, v3, v2, v0, v1}, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {v6, v0}, Ljava/security/AlgorithmParameters;->getParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    :cond_23
    invoke-virtual {p0, v7, v5, v3, v4}, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    const-string v4, "b_k#o\u001aaYeZaY\u0013bRbP[R`P\\\t"
    ...
    :pswitch_7
    iget-object v12, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->engineParams:Ljava/security/AlgorithmParameters;
    ...
    invoke-virtual {v12, v0}, Ljava/security/AlgorithmParameters;->init(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    invoke-virtual {p0, v2, v1, v0}, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->engineUpdate([BII)[B
    ...
    const-string v2, "+Z\u00167rMRjKMuL\u000bD\u001bm)]f\"f\u000fh\u0016Z-\u000c\t\u001e\u000fjI6S"
    ...
    invoke-direct {v6, v1}, Ljavax/crypto/ShortBufferException;-><init>(Ljava/lang/String;)V
...
.method public engineDoFinal([BII[BI)I
    ...
    invoke-direct {p0, v0, v2}, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ࡦࡧ࡯(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public engineGetBlockSize()I
    ...
    invoke-direct {p0, v0, v1}, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ࡦࡧ࡯(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public varargs ࡩࡥᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->ࡦࡧ࡯(I[Ljava/lang/Object;)Ljava/lang/Object;
