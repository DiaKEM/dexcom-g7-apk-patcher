...
.method private varargs ࡬࡭࡯(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :pswitch_1
    const-string v2, "S$\u000fT\"r\u00151o\\T1_x[&\u0010{T\u001b\u007f:6"
    ...
    invoke-virtual {p0, v9}, Lorg/spongycastle/jcajce/provider/asymmetric/ec/AlgorithmParametersSpi;->isASN1FormatString(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v3}, Lorg/spongycastle/jcajce/provider/asymmetric/util/EC5Util;->getCurve(Lorg/spongycastle/jcajce/provider/config/ProviderConfiguration;Lorg/spongycastle/asn1/x9/X962Parameters;)Lorg/spongycastle/math/ec/ECCurve;
    ...
    :cond_3
    invoke-static {v3, v1}, Lorg/spongycastle/jcajce/provider/asymmetric/util/EC5Util;->convertToSpec(Lorg/spongycastle/asn1/x9/X962Parameters;Lorg/spongycastle/math/ec/ECCurve;)Ljava/security/spec/ECParameterSpec;
    ...
    const-string v3, "Phdffmc\u0014X`T_SSQ\u000c[K[ITKYIUU\u0001FNPJ=OyBFv\u0017A;BD:D7;\u001d-=+6-;+77b1#*$!1uZ"
    ...
    invoke-virtual {p0, v5, v0}, Lorg/spongycastle/jcajce/provider/asymmetric/ec/AlgorithmParametersSpi;->engineInit([BLjava/lang/String;)V
    ...
    instance-of v0, v9, Ljava/security/spec/ECGenParameterSpec;

    if-eqz v0, :cond_7

    check-cast v9, Ljava/security/spec/ECGenParameterSpec;

    invoke-static {v9}, Lorg/spongycastle/jcajce/provider/asymmetric/ec/ECUtils;->getDomainParametersFromGenSpec(Ljava/security/spec/ECGenParameterSpec;)Lorg/spongycastle/asn1/x9/X9ECParameters;

    move-result-object v1

    if-eqz v1, :cond_8

    invoke-virtual {v9}, Ljava/security/spec/ECGenParameterSpec;->getName()Ljava/lang/String;
    ...
    :goto_5
    iput-object v9, p0, Lorg/spongycastle/jcajce/provider/asymmetric/ec/AlgorithmParametersSpi;->ecParameterSpec:Ljava/security/spec/ECParameterSpec;

    goto/16 :goto_10

    :cond_7
    instance-of v0, v9, Ljava/security/spec/ECParameterSpec;
    ...
    const-string v4, "s{[3TaFCe\u001f^\u0004\u000f\u0007JS\u0012V`<D7~Du()\n;\u001b2;4T\u0014&$\u000e=C >\u000c\u0019="
    ...
    :cond_b
    iget-object v2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/ec/AlgorithmParametersSpi;->ecParameterSpec:Ljava/security/spec/ECParameterSpec;
    ...
    const-string v3, "\u007f~\\~+\'04,8-3\u0017);+81A3ACp54BCEKw<IIRBPS\u007fUQ\u0003"
    ...
    invoke-direct {v7, v0}, Ljava/security/spec/InvalidParameterSpecException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v8}, Lorg/spongycastle/jcajce/provider/asymmetric/ec/AlgorithmParametersSpi;->isASN1FormatString(Ljava/lang/String;)Z
    ...
    const-string v5, "I?Js\u0019>:.DKDY\u001bl O++fx\u007f\u0013w\u000c\u001a68\u0008^\u00187\"Guu/HkcW<\n~|tr|<`\u000e]\'\';\u007fy\u000c"
    ...
    invoke-virtual {p0, v1}, Lorg/spongycastle/jcajce/provider/asymmetric/ec/AlgorithmParametersSpi;->engineGetEncoded(Ljava/lang/String;)[B
...
.method public engineGetEncoded()[B
    ...
    invoke-direct {p0, v0, v1}, Lorg/spongycastle/jcajce/provider/asymmetric/ec/AlgorithmParametersSpi;->࡬࡭࡯(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public varargs ࡩࡥᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lorg/spongycastle/jcajce/provider/asymmetric/ec/AlgorithmParametersSpi;->࡬࡭࡯(I[Ljava/lang/Object;)Ljava/lang/Object;
