...
.method private getPublicKeyDetails(Lorg/spongycastle/jce/provider/JCEECPublicKey;)Lorg/spongycastle/asn1/DERBitString;
    ...
    invoke-direct {p0, v0, v1}, Lorg/spongycastle/jce/provider/JCEECPrivateKey;->᫋᫋࡯(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method private varargs ᫋᫋࡯(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v2, "CDEFGHIJKLMNO\u0004kR"
    ...
    iput-boolean v2, p0, Lorg/spongycastle/jce/provider/JCEECPrivateKey;->withCompression:Z
    ...
    invoke-virtual {v0, v3, v2}, Lorg/spongycastle/jcajce/provider/asymmetric/util/PKCS12BagAttributeCarrierImpl;->setBagAttribute(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;Lorg/spongycastle/asn1/ASN1Encodable;)V
    ...
    invoke-direct {v4, v1}, Lorg/spongycastle/asn1/x9/X962Parameters;-><init>(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;)V
    ...
    invoke-direct {v3, v1, v0, v4}, Lorg/spongycastle/asn1/sec/ECPrivateKeyStructure;-><init>(Ljava/math/BigInteger;Lorg/spongycastle/asn1/DERBitString;Lorg/spongycastle/asn1/ASN1Encodable;)V
    ...
    invoke-direct {v4, v0}, Lorg/spongycastle/asn1/x9/X962Parameters;-><init>(Lorg/spongycastle/asn1/ASN1Null;)V
    ...
    invoke-direct {v4, v2}, Lorg/spongycastle/asn1/x9/X962Parameters;-><init>(Lorg/spongycastle/asn1/x9/X9ECParameters;)V
    ...
    invoke-direct {v3, v0, v4}, Lorg/spongycastle/asn1/sec/ECPrivateKeyStructure;-><init>(Ljava/math/BigInteger;Lorg/spongycastle/asn1/ASN1Encodable;)V

    :goto_9
    :try_start_0
    iget-object v6, p0, Lorg/spongycastle/jce/provider/JCEECPrivateKey;->algorithm:Ljava/lang/String;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    const-string v5, "\u000b\u0008\u000b\u0012\u0015\u0015rrnl"
    ...
    invoke-virtual {v3}, Lorg/spongycastle/asn1/sec/ECPrivateKeyStructure;->toASN1Primitive()Lorg/spongycastle/asn1/ASN1Primitive;

    move-result-object v0

    invoke-direct {v6, v2, v0}, Lorg/spongycastle/asn1/pkcs/PrivateKeyInfo;-><init>(Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;Lorg/spongycastle/asn1/ASN1Encodable;)V
    ...
    instance-of v0, v3, Lorg/spongycastle/jce/provider/JCEECPrivateKey;
    ...
    :cond_e
    check-cast v3, Lorg/spongycastle/jce/provider/JCEECPrivateKey;

    invoke-virtual {p0}, Lorg/spongycastle/jce/provider/JCEECPrivateKey;->getD()Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {v3}, Lorg/spongycastle/jce/provider/JCEECPrivateKey;->getD()Ljava/math/BigInteger;
    ...
    invoke-virtual {v3}, Lorg/spongycastle/jce/provider/JCEECPrivateKey;->engineGetSpec()Lorg/spongycastle/jce/spec/ECParameterSpec;
    ...
    invoke-virtual {v0, v2}, Lorg/spongycastle/jcajce/provider/asymmetric/util/PKCS12BagAttributeCarrierImpl;->writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    invoke-virtual {v0, v2}, Lorg/spongycastle/jcajce/provider/asymmetric/util/PKCS12BagAttributeCarrierImpl;->readObject(Ljava/io/ObjectInputStream;)V
    ...
    invoke-static {v2, v0}, Lorg/spongycastle/jcajce/provider/asymmetric/util/EC5Util;->convertCurve(Lorg/spongycastle/math/ec/ECCurve;[B)Ljava/security/spec/EllipticCurve;
    ...
    invoke-direct {v10, v2, v0}, Ljava/security/spec/ECPoint;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    :cond_11
    invoke-virtual {v2}, Lorg/spongycastle/asn1/x9/X962Parameters;->isImplicitlyCA()Z
    ...
    invoke-direct {v7, v5, v4, v2, v0}, Ljava/security/spec/ECParameterSpec;-><init>(Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;I)V
...
.method public varargs ࡩࡥᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lorg/spongycastle/jce/provider/JCEECPrivateKey;->᫋᫋࡯(I[Ljava/lang/Object;)Ljava/lang/Object;
