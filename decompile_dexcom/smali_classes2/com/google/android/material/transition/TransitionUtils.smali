...
.method public static calculateArea(Landroid/graphics/RectF;)F
    ...
    invoke-static {v0, v1}, Lcom/google/android/material/transition/TransitionUtils;->ࡥࡨ᫂(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static createColorShader(I)Landroid/graphics/Shader;
    ...
    invoke-static {v0, v2}, Lcom/google/android/material/transition/TransitionUtils;->ࡥࡨ᫂(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs ࡥࡨ᫂(I[Ljava/lang/Object;)Ljava/lang/Object;
    .locals 15
    ...
    check-cast v3, Lcom/google/android/material/transition/TransitionUtils$CornerSizeBinaryOperator;

    invoke-static {v5, v1}, Lcom/google/android/material/transition/TransitionUtils;->isShapeAppearanceSignificant(Lcom/google/android/material/shape/ShapeAppearanceModel;Landroid/graphics/RectF;)Z
    ...
    invoke-interface {v3, v1, v0}, Lcom/google/android/material/transition/TransitionUtils$CornerSizeBinaryOperator;->apply(Lcom/google/android/material/shape/CornerSize;Lcom/google/android/material/shape/CornerSize;)Lcom/google/android/material/shape/CornerSize;
    ...
    check-cast v2, Lcom/google/android/material/transition/TransitionUtils$CanvasOperation;
    ...
    invoke-static {v7, v6, v3}, Lcom/google/android/material/transition/TransitionUtils;->saveLayerAlphaCompat(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)I

    :cond_2
    invoke-interface {v2, v7}, Lcom/google/android/material/transition/TransitionUtils$CanvasOperation;->run(Landroid/graphics/Canvas;)V
    ...
    new-instance v9, Lcom/google/android/material/transition/MaterialArcMotion;

    invoke-direct {v9}, Lcom/google/android/material/transition/MaterialArcMotion;-><init>()V
    ...
    invoke-direct {v9, v0}, Landroidx/transition/PatternPathMotion;-><init>(Landroid/graphics/Path;)V
    ...
    const-string v2, "Y}\u0005nxtn)uvznsq\"qasf\u001dptj^2\u0017"
    ...
    const-string v4, "^a\u0013R6]Oi\u0016S=3-4\r\u00140a%\u001al_Ti[*dx\u00121/1M%R\u0006u\u0001~\u001c?oOz{4,\u007fP}\u0001\u0012v\u0003\u001e[N\u0016EI{F\u000bK%\u0008C;h\'My\u0002usd"
    ...
    invoke-virtual {v1, v0}, Landroidx/transition/TransitionSet;->removeTransition(Landroidx/transition/Transition;)Landroidx/transition/TransitionSet;
    ...
    invoke-static {v1, v0}, Lcom/google/android/material/transition/TransitionUtils;->resolveThemePath(Landroid/content/Context;I)Landroidx/transition/PathMotion;
    ...
    invoke-virtual {v7}, Landroidx/transition/Transition;->getDuration()J
    ...
    invoke-virtual {v7, v0, v1}, Landroidx/transition/Transition;->setDuration(J)Landroidx/transition/Transition;
    ...
    :cond_c
    new-instance v2, Lcom/google/android/material/transition/TransitionUtils$2;

    invoke-direct/range {v2 .. v7}, Lcom/google/android/material/transition/TransitionUtils$2;-><init>(Landroid/graphics/RectF;Landroid/graphics/RectF;FFF)V
    ...
    invoke-static {v1, v0, v2}, Lcom/google/android/material/transition/TransitionUtils;->lerp(FFF)F
    ...
    :cond_f
    invoke-static {v4, v3, v1}, Lcom/google/android/material/transition/TransitionUtils;->lerp(FFF)F
    ...
    const-string/jumbo v3, "}HS\u0001PRX\u0005G\u0007^JVTP\rO]SVegcg"
    ...
    invoke-direct {v0, v1}, Lcom/google/android/material/transition/TransitionUtils$1;-><init>(Landroid/graphics/RectF;)V
