...
.method public final tryRelativeTo(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-interface {v5, v6}, Ljava/nio/file/Path;->relativize(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-interface {v5, v2}, Ljava/nio/file/Path;->getName(I)Ljava/nio/file/Path;

    move-result-object v0

    sget-object v1, Lkotlin/io/path/PathRelativizer;->parentPath:Ljava/nio/file/Path;
    ...
    invoke-interface {v6, v2}, Ljava/nio/file/Path;->getName(I)Ljava/nio/file/Path;
    ...
    const-string p0, "LfZ\\ga\u001drn dqptzzl({owm\u0002w\u0006u1\u0003t\t}"
    ...
    const-string/jumbo p0, "{v5lnphUzsscj*n_iYiWice"
    ...
    invoke-static {p0, v4, v0}, Lfk/ᫀᫎ;->᫃(Ljava/lang/String;SS)Ljava/lang/String;
    ...
    invoke-static {v5, v7, v3, v1, v0}, Lkotlin/text/StringsKt;->endsWith$default(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    invoke-static {v5, v0}, Lkotlin/text/StringsKt;->dropLast(Ljava/lang/String;I)Ljava/lang/String;
