...
.annotation runtime Lkotlin/Metadata;
    ...
    d1 = {
        "\u06fe\u001ehaxcle|gp\u0709rk\u0003mvovqzs\u000bu~w~z\u0003{\u0013}\u0007\u007f\u0007\u0004\u000b\u0004\u0013\u0012\u000f\u0008\u000f\u000b\u0013\u000c#\u000e\u0017\u0010\u0017\u0013\u001b\u0014#\u0016\u001f\u0737!\u001a1\u001c%\u001e%\"\'\u0742%:\u0744V\'V(j6<1</H1`4\u077696E:\u0002FIPU>mUqFQZ]Fu_\u0012ZYdeN}e\u0002ZammZ\u0006\u0777*Z\n`&dmzyb\u0012y,z8wwm\u0004l\u001cr&5\u07b3vw\rw||\u0007\u007fK\u0018\u000b\u0007\u0017\u007f/\n3\u0008\u0013\r\u001f\u00087\u0012ILc\u07b3\u001b\u07d1\u0015\u0018\u001b\u07b2-\u0018\u001d\"\'%k++*7 O/Yh\u07e6*+@+09:<~>>AJ3bFl{\u07f9=>S>CPMS\u0012NQD]FuI \u07ebM\u008cQNW\u07ee\u0097Vn"
    }
    d2 = {
        "\u0012631674wl(.5\u001f-*\u001eB\u0006;H@A98B8??x\u001d1.R*IUN\u0007%XWMC$;GH\u0018",
        "\u00121)?#q0&,&n\u0013/)*\u001e8C=\u0014",
        "8,;9117*\u0001 ,-\u001c\u001c\u001f(",
        "\u0012631674wl\u0002!-&\u001d\u001d A\u0012",
        "m\u001374*785pm)/. .+7C\u0007<AAB:1C9@8y\u001e2GS+JNO\u001f1MJHUNK\u000f\u000c9XdeTTW`)\u0018F",
        ")(45",
        "\u0012631674wl(.5\u001f-*\u001eB\u0006;H@A98B8??x\u001d1.R*IUN\u001e",
        "-,<\u000c#/0",
        "mo\u00148-+89.qn*(/!/D8D\u00085BBC32D:99z\u001fKHT,COP ",
        "\u0002:-=n\u0002\u0002",
        "\u00121)?#q99\'+n$))\u001f2HI=GF\u00025I=<94x\u000c@<SPK2PWILCQ\u001b",
        ")(455\u0013)7\u0006.35",
        "-,<\u000c#/08\u000e$2\t).0",
        "mo\u00143#9%s33)-h\u001e++9LJK7AH\u0004/C?>3.z\u000eZVURE,RYCFES\u0015",
        ".6;=",
        "",
        "-,<\u0011168",
        "mo\u00143#9%s* .(h\u000e0/?E?\u0014",
...
.method public constructor <init>(Lokhttp3/internal/connection/RealCall;Lokhttp3/Callback;)V
    ...
    const-string v5, "K?NLLLRE$COPGGJS"
    ...
    iput-object v1, p0, Lokhttp3/internal/connection/RealCall$AsyncCall;->callsPerHost:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private varargs ᫕࡭᫖(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v1, v0, v5}, Lokhttp3/Callback;->onResponse(Lokhttp3/Call;Lokhttp3/Response;)V
    ...
    invoke-interface {v1, v0, v6}, Lokhttp3/Callback;->onFailure(Lokhttp3/Call;Ljava/io/IOException;)V
    ...
    const-string v13, ".MYZQQT]\u0013ZV_cmk_\u001bblp\u001f"
    ...
    invoke-virtual {v6, v1, v0, v5}, Lokhttp3/internal/platform/Platform;->log(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    invoke-interface {v1, v0, v5}, Lokhttp3/Callback;->onFailure(Lokhttp3/Call;Ljava/io/IOException;)V
    :try_end_6
    ...
    iget-object v0, v5, Lokhttp3/internal/connection/RealCall$AsyncCall;->callsPerHost:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    const-string/jumbo v2, "x\u000bvs\u0005\u0003|~^o{~pij"
    ...
    const-string v3, "\rP\t\u001fk2cpDTVgB>\u000ek-&I\u0011\u0016B"
    ...
    const-string v11, "\u00084;88\u0003004~FLH?yEG:AtCAq"
    ...
    const-string/jumbo v10, "\u007fm\u001cw#w\u0005!\u0012F1\u001adfe>\u0013"
    ...
    :try_start_b
    invoke-direct {v3, v1}, Ljava/io/InterruptedIOException;-><init>(Ljava/lang/String;)V

    invoke-virtual {v3, v7}, Ljava/lang/Throwable;->initCause(Ljava/lang/Throwable;)Ljava/lang/Throwable;

    iget-object v0, p0, Lokhttp3/internal/connection/RealCall$AsyncCall;->this$0:Lokhttp3/internal/connection/RealCall;

    invoke-virtual {v0, v3}, Lokhttp3/internal/connection/RealCall;->noMoreExchanges$okhttp(Ljava/io/IOException;)Ljava/io/IOException;

    iget-object v1, p0, Lokhttp3/internal/connection/RealCall$AsyncCall;->responseCallback:Lokhttp3/Callback;

    iget-object v0, p0, Lokhttp3/internal/connection/RealCall$AsyncCall;->this$0:Lokhttp3/internal/connection/RealCall;

    invoke-interface {v1, v0, v3}, Lokhttp3/Callback;->onFailure(Lokhttp3/Call;Ljava/io/IOException;)V
    :try_end_b
...
.method public final executeOn(Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/connection/RealCall$AsyncCall;->᫕࡭᫖(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public varargs ࡩࡥᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lokhttp3/internal/connection/RealCall$AsyncCall;->᫕࡭᫖(I[Ljava/lang/Object;)Ljava/lang/Object;
