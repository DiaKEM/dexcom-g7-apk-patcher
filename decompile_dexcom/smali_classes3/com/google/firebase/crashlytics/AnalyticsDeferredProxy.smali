...
# instance fields
.field public final analyticsConnectorDeferred:Lcom/google/firebase/inject/Deferred;
...
.field public volatile analyticsEventLogger:Lcom/google/firebase/crashlytics/internal/analytics/AnalyticsEventLogger;

.field public final breadcrumbHandlerList:Ljava/util/List;
...
.field public volatile breadcrumbSource:Lcom/google/firebase/crashlytics/internal/breadcrumbs/BreadcrumbSource;
...
.method public constructor <init>(Lcom/google/firebase/inject/Deferred;)V
    ...
    new-instance v1, Lcom/google/firebase/crashlytics/internal/breadcrumbs/DisabledBreadcrumbSource;

    invoke-direct {v1}, Lcom/google/firebase/crashlytics/internal/breadcrumbs/DisabledBreadcrumbSource;-><init>()V
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/google/firebase/crashlytics/AnalyticsDeferredProxy;-><init>(Lcom/google/firebase/inject/Deferred;Lcom/google/firebase/crashlytics/internal/breadcrumbs/BreadcrumbSource;Lcom/google/firebase/crashlytics/internal/analytics/AnalyticsEventLogger;)V
...
.method public static synthetic a(Lcom/google/firebase/crashlytics/AnalyticsDeferredProxy;Lcom/google/firebase/inject/Provider;)V
    ...
    invoke-static {v0, v1}, Lcom/google/firebase/crashlytics/AnalyticsDeferredProxy;->࡫ࡰ᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method private init()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/google/firebase/crashlytics/AnalyticsDeferredProxy;->࡬ࡰ᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs ࡫ࡰ᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v8, Lcom/google/firebase/crashlytics/CrashlyticsAnalyticsListener;

    const-string v10, "CMZ"
    ...
    const-string v2, "<glbY\u0014aae\u0010aSTU^^NZ\u0007\'SEO[UIBQ KIH>;KEG <EE5=3?kB3=0f\t7%6*-93\' /Z)+!\u001e\u001f#a"
    ...
    const-string v3, "\u0007\u0016V2k^]T>\u0004\u007f_+V:\u0010\u0010\u0007\"\u0003zQ\u0018 A~\u0015~J\u0005 Hq&D{-y_VY&\u001e+2\u0011V}>ceDU\u000c\u001aGK]]\\\r\u0017\u007f\u001b=\u0019U\u0016\u0001\u000bQ\u0012eWF;HsS<\'S~\u0014\nU,7pxZo\u0010Nk\u0003\u0003\u007f\'\u0003M\u000bJ~ILK\u0003>\u0017tA\u0003XIu.\u001e\u00064K;P$\u0008eqC\u0017ivz1\u0004\u001d\u00196,Dh\u000fG_&AZ|X-L.\u0007\u001dA#s\u001e\u001bM\u0001\u001ac?l\u0019qc\u00196\u001f"
    ...
    check-cast v1, Lcom/google/firebase/crashlytics/AnalyticsDeferredProxy;
    ...
    invoke-direct {v1, v0}, Lcom/google/firebase/crashlytics/AnalyticsDeferredProxy;->lambda$getDeferredBreadcrumbSource$0(Lcom/google/firebase/crashlytics/internal/breadcrumbs/BreadcrumbHandler;)V
    ...
    invoke-direct {v1, v0}, Lcom/google/firebase/crashlytics/AnalyticsDeferredProxy;->lambda$init$2(Lcom/google/firebase/inject/Provider;)V
...
.method private varargs ࡬ࡰ᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v8, Lcom/google/firebase/inject/Provider;

    invoke-static {}, Lcom/google/firebase/crashlytics/internal/Logger;->getLogger()Lcom/google/firebase/crashlytics/internal/Logger;

    move-result-object v7

    const-string v2, "Kymy\u0008\u0004yt\u0006V\u0004\u0004\u0005|{\u000e\n\u000e<\u000c\u000e\u0017@\u0003\u0019\u0005\u000e\u0012\u0008\n\u0015\u000fX"
    ...
    invoke-interface {v8}, Lcom/google/firebase/inject/Provider;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/google/firebase/analytics/connector/AnalyticsConnector;

    new-instance v6, Lcom/google/firebase/crashlytics/internal/analytics/CrashlyticsOriginAnalyticsEventLogger;

    invoke-direct {v6, v0}, Lcom/google/firebase/crashlytics/internal/analytics/CrashlyticsOriginAnalyticsEventLogger;-><init>(Lcom/google/firebase/analytics/connector/AnalyticsConnector;)V
    ...
    const-string v2, "CUVW``P\\NL\u0007,NVHDBSD}\u001eJ<FRL@9Hs?;DD4<2>x"
    ...
    invoke-direct {v2, v6, v1, v0}, Lcom/google/firebase/crashlytics/internal/analytics/BlockingAnalyticsEventLogger;-><init>(Lcom/google/firebase/crashlytics/internal/analytics/CrashlyticsOriginAnalyticsEventLogger;ILjava/util/concurrent/TimeUnit;)V
    ...
    invoke-virtual {v4, v0}, Lcom/google/firebase/crashlytics/internal/analytics/BreadcrumbAnalyticsEventReceiver;->registerBreadcrumbHandler(Lcom/google/firebase/crashlytics/internal/breadcrumbs/BreadcrumbHandler;)V

    goto :goto_1

    :cond_1
    invoke-virtual {v5, v4}, Lcom/google/firebase/crashlytics/CrashlyticsAnalyticsListener;->setBreadcrumbEventReceiver(Lcom/google/firebase/crashlytics/internal/analytics/AnalyticsEventReceiver;)V

    invoke-virtual {v5, v2}, Lcom/google/firebase/crashlytics/CrashlyticsAnalyticsListener;->setCrashlyticsOriginEventReceiver(Lcom/google/firebase/crashlytics/internal/analytics/AnalyticsEventReceiver;)V
    ...
    const-string v9, "`(L\u0001=y\rZ-x6\u0006k*=p\u0001\tZGZ\u0013\u00139\u0006\u001f\u0003Y\u000f\u001eso_Q,\u0004j_^\u001c/\u001b\u000e0\u000fQ\u0004ctY\u000eZ\u0001&i\u0014b?\n\u0005\u001c h\u0018#~,\u000b{\u000b^\u001cHR]:$)\u0005y2"
    ...
    :pswitch_3
    iget-object v1, p0, Lcom/google/firebase/crashlytics/AnalyticsDeferredProxy;->analyticsConnectorDeferred:Lcom/google/firebase/inject/Deferred;
    ...
    invoke-direct {v3, p0}, Lcom/google/firebase/crashlytics/a;-><init>(Lcom/google/firebase/crashlytics/AnalyticsDeferredProxy;)V
    ...
    invoke-direct {v3, p0}, Lcom/google/firebase/crashlytics/b;-><init>(Lcom/google/firebase/crashlytics/AnalyticsDeferredProxy;)V
...
.method public varargs ࡩࡥᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/firebase/crashlytics/AnalyticsDeferredProxy;->࡬ࡰ᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
