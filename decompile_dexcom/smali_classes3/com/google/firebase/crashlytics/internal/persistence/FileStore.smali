...
.field public static final CRASHLYTICS_PATH_V1:Ljava/lang/String; = ""

# The value of this static final field might be set in the static constructor
.field public static final CRASHLYTICS_PATH_V2:Ljava/lang/String; = ""

# The value of this static final field might be set in the static constructor
.field public static final NATIVE_REPORTS_PATH:Ljava/lang/String; = ""

# The value of this static final field might be set in the static constructor
.field public static final NATIVE_SESSION_SUBDIR:Ljava/lang/String; = ""

# The value of this static final field might be set in the static constructor
.field public static final PRIORITY_REPORTS_PATH:Ljava/lang/String; = ""

# The value of this static final field might be set in the static constructor
.field public static final REPORTS_PATH:Ljava/lang/String; = ""

# The value of this static final field might be set in the static constructor
.field public static final SESSIONS_PATH:Ljava/lang/String; = ""


# instance fields
.field public final crashlyticsDir:Ljava/io/File;

.field public final filesDir:Ljava/io/File;

.field public final nativeReportsDir:Ljava/io/File;

.field public final priorityReportsDir:Ljava/io/File;

.field public final reportsDir:Ljava/io/File;

.field public final sessionsDir:Ljava/io/File;
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->SESSIONS_PATH:Ljava/lang/String;

    const-string v3, "_Q[Y[\\Z"
    ...
    sput-object v0, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->REPORTS_PATH:Ljava/lang/String;

    const-string v4, "=V~-0,eRxIr\u0006\u0007Fg-"
    ...
    sput-object v0, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->PRIORITY_REPORTS_PATH:Ljava/lang/String;
    ...
    const v0, 0x63b1601e    # 6.5439993E21f
    ...
    sput-object v1, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->NATIVE_SESSION_SUBDIR:Ljava/lang/String;

    const-string v5, "[M_S_M\u0014XJTRTUS"
    ...
    sput-object v0, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->NATIVE_REPORTS_PATH:Ljava/lang/String;

    const-string v3, "*\u000f=ctr^/y\u0003\u0012\u0001g\\u\u000f09s.9\u001bPCw\u0011yX\u0017\u007f_WcwL\u0007kW\u0013O\t"
    ...
    sput-object v1, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->CRASHLYTICS_PATH_V2:Ljava/lang/String;

    const-string v4, "%[hg)clmflf0imwkii|o9o\u007fo\u0003x}\u000c\u0008}x\nE~\u0003\u0007\u0001\u0010K\u0015P"
    ...
    sput-object v1, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->CRASHLYTICS_PATH_V1:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v6, p0, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->filesDir:Ljava/io/File;
    ...
    const-string v4, "l!,)h!(\'\u001e\"\u001aa\u0019\u001b#\u0015\u0011\u000f \u0011X\r\u001b\t\u001a\u000e\u0011\u001d\u0017\u000b\u0004\u0013L\u0004\u0006\u0008\u007f\rF\u000eH"
    ...
    :cond_1
    const-string v4, "9oxw5otujpf0eioc]]l_%[gWf\\]kcYPaY\u0013\u0013\u0017\r\u001cS\u001dT"
    ...
    iput-object v9, p0, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->crashlyticsDir:Ljava/io/File;

    new-instance v5, Ljava/io/File;

    const-string v4, "\u0007\u0010\t\u001e){q\u000cHFT[1"
    ...
    invoke-static {v5}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->prepareBaseDir(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-direct {v7, v9, v1}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-static {v7}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->prepareBaseDir(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {v3}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->prepareBaseDir(Ljava/io/File;)Ljava/io/File;
    ...
    const-string/jumbo v3, "vDC,.\u0001$M32\u001dtjM"
    ...
    invoke-static {v8}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->prepareBaseDir(Ljava/io/File;)Ljava/io/File;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->nativeReportsDir:Ljava/io/File;
...
.method private cleanupDir(Ljava/io/File;)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->ࡢࡦ᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static declared-synchronized prepareBaseDir(Ljava/io/File;)Ljava/io/File;
    .locals 2
    ...
    invoke-static {v0, v1}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->᫖ࡦ᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static prepareDir(Ljava/io/File;)Ljava/io/File;
    .locals 2
...
.method public static useV2FileSystem()Z
    .locals 2
...
.method private varargs ࡢࡦ᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v7}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->recursiveDelete(Ljava/io/File;)Z
    ...
    const-string/jumbo v4, "{\u001e& 0\"\"^03\'9-4;:g\u000c<,?5:HD:5Fs;?C=xMTOQCL\u001a\u0001"
    ...
    invoke-direct {p0, v2}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->getSessionDir(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {p0, v1}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->getSessionDir(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->getSessionDir(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v6}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->prepareDir(Ljava/io/File;)Ljava/io/File;
    ...
    iget-object v6, p0, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->filesDir:Ljava/io/File;

    const-string v4, "\u001dQ\\Y\u0019QXWNRJ\u0012IKSEA?PA\t=K9J>AMG;4C"
    ...
    invoke-direct {p0, v7}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->cleanupDir(Ljava/io/File;)V

    new-instance v8, Ljava/io/File;

    iget-object v7, p0, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->filesDir:Ljava/io/File;

    const-string v3, "\u0002S5\nl\\Al8\u001bYwom/%_\u0012\u001e}\u001a\u0004f\u0001qW/_3yo\u0014\u00102I0"
    ...
    invoke-direct {p0, v8}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->cleanupDir(Ljava/io/File;)V
    ...
    const-string v4, "9D\"|eAq\u0012:@?aNCP\"a^9?HZK6\u0019U<\u000cdL.\u001b\u0006[v7Y\u007f%w*"
...
.method public static varargs ᫖ࡦ᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-class p1, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;
    ...
    const-string v5, "2\u0018]_gaqgmg!hlpj&hvm*n~ro\u0004y\u007fy3\u0003z\u000e7|\u0003\r\u0001\u007f\u0012\u000e\u0012\u001aO"
    ...
    const-string v4, "\u0010=D<-i9;9e*:&#7)\\\u00011!,\"\'5)\u001f\u001a+]%#\u0019PWUYL\nOUWKJ\\PT\\\u001e|"
...
.method public varargs ࡩࡥᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/firebase/crashlytics/internal/persistence/FileStore;->ࡢࡦ᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
