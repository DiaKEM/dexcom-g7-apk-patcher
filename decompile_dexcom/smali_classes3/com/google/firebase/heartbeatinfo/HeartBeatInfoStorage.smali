...
# The value of this static final field might be set in the static constructor
.field public static final HEARTBEAT_PREFERENCES_NAME:Ljava/lang/String; = ""

.field public static final HEART_BEAT_COUNT_LIMIT:I = 0x1e

# The value of this static final field might be set in the static constructor
.field public static final HEART_BEAT_COUNT_TAG:Ljava/lang/String; = ""

# The value of this static final field might be set in the static constructor
.field public static final LAST_STORED_DATE:Ljava/lang/String; = ""

# The value of this static final field might be set in the static constructor
.field public static final PREFERENCES_NAME:Ljava/lang/String; = ""

.field public static instance:Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->PREFERENCES_NAME:Ljava/lang/String;

    const-string v3, " \u0016)+d.-  i\" 4&"
    ...
    sput-object v0, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->LAST_STORED_DATE:Ljava/lang/String;

    const-string/jumbo v4, "~\u0001\tzAv\u0002\u0007~\u0004"
    ...
    sput-object v1, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->HEART_BEAT_COUNT_TAG:Ljava/lang/String;

    const-string v2, "m\u0012\u001c\u0010\u000e\u000e!\u0014w\u0016\u0013%(v\u001b\u0018,"
    ...
    sput-object v0, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->HEARTBEAT_PREFERENCES_NAME:Ljava/lang/String;

    const-string v4, "OQ]O\u0012KSUSQ_"
...
.method private declared-synchronized cleanUpStoredHeartBeats()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->ࡪ᫕᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method private declared-synchronized getFormattedDate(J)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v2}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->ࡪ᫕᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method private varargs ࡪ᫕᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    invoke-direct {v1, v4}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->removeStoredDate(Ljava/lang/String;)V

    new-instance v3, Ljava/util/HashSet;

    iget-object v2, v1, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->firebaseSharedPreferences:Landroid/content/SharedPreferences;
    ...
    iget-object v0, v1, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->firebaseSharedPreferences:Landroid/content/SharedPreferences;
    ...
    :try_start_1
    invoke-direct {v1, v5}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->getStoredUserAgentString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v2, v4, v0}, Landroid/content/SharedPreferences;->getStringSet(Ljava/lang/String;Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-virtual {v2, v0}, Ljava/time/Instant;->atOffset(Ljava/time/ZoneOffset;)Ljava/time/OffsetDateTime;
    ...
    :try_start_5
    iget-object v5, v1, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->firebaseSharedPreferences:Landroid/content/SharedPreferences;
    ...
    invoke-interface {v0, v7, v3}, Landroid/content/SharedPreferences$Editor;->putStringSet(Ljava/lang/String;Ljava/util/Set;)Landroid/content/SharedPreferences$Editor;

    move-result-object v8

    const-string v7, "npxj1fqvns"
    ...
    :try_start_7
    invoke-direct {v1, v2, v3}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->getFormattedDate(J)Ljava/lang/String;

    move-result-object v9

    iget-object v5, v1, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->firebaseSharedPreferences:Landroid/content/SharedPreferences;

    const-string v4, "<0AAx@=.,s*&8("
    ...
    invoke-direct {v1, v9}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->getStoredUserAgentString(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_a
    :try_start_9
    invoke-direct {v1, v7, v9}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->updateStoredUserAgent(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_9
    ...
    :cond_b
    :try_start_a
    iget-object v8, v1, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->firebaseSharedPreferences:Landroid/content/SharedPreferences;
    ...
    invoke-direct {v1}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->cleanUpStoredHeartBeats()V

    iget-object v11, v1, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->firebaseSharedPreferences:Landroid/content/SharedPreferences;

    const-string v3, "j8c\\F{*2=q"
    ...
    invoke-interface {v0, v7, v8}, Landroid/content/SharedPreferences$Editor;->putStringSet(Ljava/lang/String;Ljava/util/Set;)Landroid/content/SharedPreferences$Editor;

    move-result-object v8

    const-string v10, "Y]g[$[hoip"
    ...
    const-string/jumbo v5, "}q\u0003\u0003:\u0002~om5kgyi"
    ...
    invoke-virtual {v1, v5, v6, v3, v4}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->isSameDateUtc(JJ)Z
    ...
    invoke-virtual {v1, v0, v2, v3}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->shouldSendSdkHeartBeat(Ljava/lang/String;J)Z
    ...
    invoke-direct {v1, v7}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->removeStoredDate(Ljava/lang/String;)V
    :try_end_e
    ...
    :try_start_f
    invoke-direct {v1, v5, v6}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->getFormattedDate(J)Ljava/lang/String;

    move-result-object v2

    invoke-direct {v1, v3, v4}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->getFormattedDate(J)Ljava/lang/String;
    ...
    invoke-static {v3, v2}, Lcom/google/firebase/heartbeatinfo/HeartBeatResult;->create(Ljava/lang/String;Ljava/util/List;)Lcom/google/firebase/heartbeatinfo/HeartBeatResult;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->updateGlobalHeartBeat(J)V
    :try_end_11
...
.method public varargs ࡩࡥᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/firebase/heartbeatinfo/HeartBeatInfoStorage;->ࡪ᫕᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
