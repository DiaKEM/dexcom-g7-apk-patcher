...
.method public constructor <init>(Lorg/json/JSONObject;)V
    ...
    iput-object v0, p0, Lcom/google/crypto/tink/JsonKeysetReader;->inputStream:Ljava/io/InputStream;
...
.method private encryptedKeysetFromJson(Lorg/json/JSONObject;)Lcom/google/crypto/tink/proto/EncryptedKeyset;
    ...
    invoke-direct {p0, v0, v1}, Lcom/google/crypto/tink/JsonKeysetReader;->ࡪ᫄᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static withBytes([B)Lcom/google/crypto/tink/JsonKeysetReader;
    ...
    invoke-static {v0, v1}, Lcom/google/crypto/tink/JsonKeysetReader;->᫊᫄᫓(I[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/google/crypto/tink/JsonKeysetReader;
...
.method private varargs ࡪ᫄᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/google/crypto/tink/JsonKeysetReader;->inputStream:Ljava/io/InputStream;

    invoke-static {v0}, Lcom/google/crypto/tink/Util;->readAll(Ljava/io/InputStream;)[B

    move-result-object v1

    sget-object v0, Lcom/google/crypto/tink/JsonKeysetReader;->UTF_8:Ljava/nio/charset/Charset;

    invoke-direct {v2, v1, v0}, Ljava/lang/String;-><init>([BLjava/nio/charset/Charset;)V

    invoke-direct {v3, v2}, Lorg/json/JSONObject;-><init>(Ljava/lang/String;)V

    invoke-direct {p0, v3}, Lcom/google/crypto/tink/JsonKeysetReader;->encryptedKeysetFromJson(Lorg/json/JSONObject;)Lcom/google/crypto/tink/proto/EncryptedKeyset;
    ...
    invoke-direct {p0, v3}, Lcom/google/crypto/tink/JsonKeysetReader;->keysetFromJson(Lorg/json/JSONObject;)Lcom/google/crypto/tink/proto/Keyset;
    ...
    invoke-direct {v6, v1}, Lorg/json/JSONException;-><init>(Ljava/lang/String;)V
    ...
    const-string v10, "p\'^9u\"N[p\tO0\u0007\u000eB#S@<%jt7\u0017"
    ...
    invoke-direct {v7, v1}, Lorg/json/JSONException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v0}, Lcom/google/crypto/tink/proto/KeysetInfo$Builder;->setPrimaryKeyId(I)Lcom/google/crypto/tink/proto/KeysetInfo$Builder;

    :cond_1a
    const-string v6, ">9N\u001fE>H"
    ...
    invoke-direct {p0, v0}, Lcom/google/crypto/tink/JsonKeysetReader;->keyInfoFromJson(Lorg/json/JSONObject;)Lcom/google/crypto/tink/proto/KeysetInfo$KeyInfo;

    move-result-object v0

    invoke-virtual {v4, v0}, Lcom/google/crypto/tink/proto/KeysetInfo$Builder;->addKeyInfo(Lcom/google/crypto/tink/proto/KeysetInfo$KeyInfo;)Lcom/google/crypto/tink/proto/KeysetInfo$Builder;
    ...
    invoke-direct {p0, v5}, Lcom/google/crypto/tink/JsonKeysetReader;->validateKeyset(Lorg/json/JSONObject;)V
    ...
    invoke-direct {p0, v0}, Lcom/google/crypto/tink/JsonKeysetReader;->keyFromJson(Lorg/json/JSONObject;)Lcom/google/crypto/tink/proto/Keyset$Key;
    ...
    invoke-direct {p0, v0}, Lcom/google/crypto/tink/JsonKeysetReader;->getStatus(Ljava/lang/String;)Lcom/google/crypto/tink/proto/KeyStatusType;

    move-result-object v0

    invoke-virtual {v4, v0}, Lcom/google/crypto/tink/proto/KeysetInfo$KeyInfo$Builder;->setStatus(Lcom/google/crypto/tink/proto/KeyStatusType;)Lcom/google/crypto/tink/proto/KeysetInfo$KeyInfo$Builder;

    move-result-object v5

    const-string v6, "D=P\u001f9"
    ...
    invoke-virtual {v5, v0}, Lcom/google/crypto/tink/proto/KeysetInfo$KeyInfo$Builder;->setKeyId(I)Lcom/google/crypto/tink/proto/KeysetInfo$KeyInfo$Builder;

    move-result-object v5

    const-string v4, ">\u0012\u00157o\u0013Pe\u000b.\u0008|(?&\u0001"
    ...
    invoke-direct {p0, v0}, Lcom/google/crypto/tink/JsonKeysetReader;->getOutputPrefixType(Ljava/lang/String;)Lcom/google/crypto/tink/proto/OutputPrefixType;

    move-result-object v0

    invoke-virtual {v5, v0}, Lcom/google/crypto/tink/proto/KeysetInfo$KeyInfo$Builder;->setOutputPrefixType(Lcom/google/crypto/tink/proto/OutputPrefixType;)Lcom/google/crypto/tink/proto/KeysetInfo$KeyInfo$Builder;

    move-result-object v7

    const-string v3, "BH@6\'E@"
    ...
    invoke-virtual {v7, v0}, Lcom/google/crypto/tink/proto/KeysetInfo$KeyInfo$Builder;->setTypeUrl(Ljava/lang/String;)Lcom/google/crypto/tink/proto/KeysetInfo$KeyInfo$Builder;
    ...
    invoke-direct {p0, v8}, Lcom/google/crypto/tink/JsonKeysetReader;->validateKey(Lorg/json/JSONObject;)V

    invoke-static {}, Lcom/google/crypto/tink/proto/Keyset$Key;->newBuilder()Lcom/google/crypto/tink/proto/Keyset$Key$Builder;

    move-result-object v4

    const-string v10, "c\u0019pKK\u0010"
    ...
    invoke-virtual {v4, v0}, Lcom/google/crypto/tink/proto/Keyset$Key$Builder;->setStatus(Lcom/google/crypto/tink/proto/KeyStatusType;)Lcom/google/crypto/tink/proto/Keyset$Key$Builder;
    ...
    invoke-virtual {v6, v0}, Lcom/google/crypto/tink/proto/Keyset$Key$Builder;->setKeyId(I)Lcom/google/crypto/tink/proto/Keyset$Key$Builder;

    move-result-object v3

    const-string v2, "\u0012\u0017\u0015\u0010\u0014\u0012l\u000e\u007f\u007f\u0002\u0010j\u000f\u0005x"
    ...
    invoke-virtual {v3, v0}, Lcom/google/crypto/tink/proto/Keyset$Key$Builder;->setOutputPrefixType(Lcom/google/crypto/tink/proto/OutputPrefixType;)Lcom/google/crypto/tink/proto/Keyset$Key$Builder;

    move-result-object v5

    const-string/jumbo v3, "xmJNk3\u0006"
    ...
    invoke-direct {p0, v0}, Lcom/google/crypto/tink/JsonKeysetReader;->keyDataFromJson(Lorg/json/JSONObject;)Lcom/google/crypto/tink/proto/KeyData;

    move-result-object v0

    invoke-virtual {v5, v0}, Lcom/google/crypto/tink/proto/Keyset$Key$Builder;->setKeyData(Lcom/google/crypto/tink/proto/KeyData;)Lcom/google/crypto/tink/proto/Keyset$Key$Builder;
    ...
    invoke-direct {p0, v4}, Lcom/google/crypto/tink/JsonKeysetReader;->validateKeyData(Lorg/json/JSONObject;)V

    iget-boolean v6, p0, Lcom/google/crypto/tink/JsonKeysetReader;->urlSafeBase64:Z

    const-string v5, "iS]eT"
    ...
    invoke-virtual {v6, v0}, Lcom/google/crypto/tink/proto/KeyData$Builder;->setTypeUrl(Ljava/lang/String;)Lcom/google/crypto/tink/proto/KeyData$Builder;

    move-result-object v1

    invoke-static {v10}, Lcom/google/crypto/tink/shaded/protobuf/ByteString;->copyFrom([B)Lcom/google/crypto/tink/shaded/protobuf/ByteString;
    ...
    invoke-direct {p0, v0}, Lcom/google/crypto/tink/JsonKeysetReader;->getKeyMaterialType(Ljava/lang/String;)Lcom/google/crypto/tink/proto/KeyData$KeyMaterialType;

    move-result-object v0

    invoke-virtual {v3, v0}, Lcom/google/crypto/tink/proto/KeyData$Builder;->setKeyMaterialType(Lcom/google/crypto/tink/proto/KeyData$KeyMaterialType;)Lcom/google/crypto/tink/proto/KeyData$Builder;
    ...
    const-string/jumbo v2, "sxkjaolb["
    ...
    :cond_37
    const-string/jumbo v3, "y\u001b4,\\(V:\u0008bW1#9}\u0003Gm"
    ...
    :cond_38
    const-string v3, "E/CS\u000c6\u001d{CQo~TGAh)"
    ...
    const-string v4, "\u001fp/\u000f\u00084S-+\u0006o@\\BE\\.\u0013SJ@]\r\u007fvs{"
    ...
    invoke-direct {v7, v0}, Lorg/json/JSONException;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v7}, Lcom/google/crypto/tink/JsonKeysetReader;->validateEncryptedKeyset(Lorg/json/JSONObject;)V

    iget-boolean v5, p0, Lcom/google/crypto/tink/JsonKeysetReader;->urlSafeBase64:Z

    const-string v4, "\u0014s~:h,\u001e.y;{\u0018E.+"
    ...
    const-string/jumbo v5, "vq\u0007\u0002t\u0005Z\u0001y\u0004"
    ...
    invoke-direct {p0, v0}, Lcom/google/crypto/tink/JsonKeysetReader;->keysetInfoFromJson(Lorg/json/JSONObject;)Lcom/google/crypto/tink/proto/KeysetInfo;

    move-result-object v0

    invoke-virtual {v6, v0}, Lcom/google/crypto/tink/proto/EncryptedKeyset$Builder;->setKeysetInfo(Lcom/google/crypto/tink/proto/KeysetInfo;)Lcom/google/crypto/tink/proto/EncryptedKeyset$Builder;
...
.method public static varargs ᫊᫄᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v2, Lcom/google/crypto/tink/JsonKeysetReader;
    ...
    invoke-direct {v2, v1}, Lcom/google/crypto/tink/JsonKeysetReader;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-direct {v2, v0}, Lcom/google/crypto/tink/JsonKeysetReader;-><init>(Lorg/json/JSONObject;)V
    ...
    invoke-direct {v2, v0}, Lcom/google/crypto/tink/JsonKeysetReader;-><init>(Ljava/io/InputStream;)V
...
.method public varargs ࡩࡥᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/crypto/tink/JsonKeysetReader;->ࡪ᫄᫓(I[Ljava/lang/Object;)Ljava/lang/Object;
