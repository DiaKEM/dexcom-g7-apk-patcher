...
.method public static constructor <clinit>()V
    ...
    const-string v2, "\u0017Z),q\u0010w}Gkd\u0004LG,i:"
    ...
    const-string v4, "if`|\u0007v\\~qx_\u007fkls[xfgh"
...
.method public static getDatabaseInfo()Lnet/sqlcipher/database/SQLiteDebug$PagerStats;
    ...
    invoke-static {v0, v1}, Lnet/sqlcipher/database/SQLiteDebug;->᫒ࡪ᫖(I[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lnet/sqlcipher/database/SQLiteDebug$PagerStats;
...
.method public static varargs ᫒ࡪ᫖(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :sswitch_0
    const-class p0, Lnet/sqlcipher/database/SQLiteDebug;

    monitor-enter p0

    :try_start_0
    sget v2, Lnet/sqlcipher/database/SQLiteDebug;->sNumActiveCursorsFinalized:I
    ...
    :cond_0
    sput v2, Lnet/sqlcipher/database/SQLiteDebug;->sNumActiveCursorsFinalized:I
    :try_end_0
    ...
    :sswitch_2
    new-instance p1, Lnet/sqlcipher/database/SQLiteDebug$PagerStats;

    invoke-direct {p1}, Lnet/sqlcipher/database/SQLiteDebug$PagerStats;-><init>()V

    invoke-static {p1}, Lnet/sqlcipher/database/SQLiteDebug;->getPagerStats(Lnet/sqlcipher/database/SQLiteDebug$PagerStats;)V

    invoke-static {}, Lnet/sqlcipher/database/SQLiteDatabase;->getDbStats()Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p1, Lnet/sqlcipher/database/SQLiteDebug$PagerStats;->dbStats:Ljava/util/ArrayList;
