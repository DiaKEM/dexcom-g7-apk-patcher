...
.field public static final SQLITE_EXCEPTION_DETAIL_MESSAGE:Ljava/lang/String; = ""
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lnet/sqlcipher/database/SqliteWrapper;->TAG:Ljava/lang/String;

    const-string/jumbo v4, "~\u000cG\u001e\u0001J7`\u001d\u0011\u0004.\u0017,Q1\u0011 \u001c\u001fm\u000c\u001d#doj\u0014"
    ...
    const v0, 0x4e3b8fc7    # 7.866905E8f

    const v2, 0x4e3b8be6    # 7.8662694E8f
    ...
    sput-object v1, Lnet/sqlcipher/database/SqliteWrapper;->SQLITE_EXCEPTION_DETAIL_MESSAGE:Ljava/lang/String;
...
.method public static checkSQLiteException(Landroid/content/Context;Lnet/sqlcipher/database/SQLiteException;)V
    ...
    invoke-static {v0, v1}, Lnet/sqlcipher/database/SqliteWrapper;->᫗᫊᫖(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs ᫗᫊᫖(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v4, "\u000f.B28p3r\'&\"@L>\u001fS?BNSIPP\u0003[MKU\u0008^ZOMaS)\u0010"
    ...
    invoke-static {v7, v8}, Lnet/sqlcipher/database/SqliteWrapper;->checkSQLiteException(Landroid/content/Context;Lnet/sqlcipher/database/SQLiteException;)V
    ...
    const-string/jumbo v3, "t\u0012$\u0012\u001eT\u0015R\r\n\u0004 2\"\u00013%&03/42bA1-5m?1<\u0007u\u0002\u0008O4"
    ...
    const-string v2, "Wv\u000bz\u00019{;onj\t\u0015\u0007g\u001c\u0008\u000b\u0017\u001c\u0012\u0019\u0019K$\u0016\u0014\u001eP#(\u0019\'/pW"
    ...
    invoke-static {v3, v8}, Lnet/sqlcipher/database/SqliteWrapper;->checkSQLiteException(Landroid/content/Context;Lnet/sqlcipher/database/SQLiteException;)V
    ...
    const-string/jumbo v4, "}uggph\"uo\u001fmmai\u001a]YkWWUfW\u0011VXZR"
    ...
    goto :goto_a
    :try_end_3
    .catch Lnet/sqlcipher/database/SQLiteException; {:try_start_3 .. :try_end_3} :catch_3

    :catch_3
    move-exception v5

    const-string v7, "\u00014\u001bfU\u0004O\u0014=L$b/"
    ...
    const-string/jumbo v3, "~V\u001c\"gz\u0018&\'TUP\t\u0004gx\u001b#e2d\u0016f\u0018i&\u0001UT\u000clO-\u0008Ob\u001a"
    ...
    invoke-static {v4, v5}, Lnet/sqlcipher/database/SqliteWrapper;->checkSQLiteException(Landroid/content/Context;Lnet/sqlcipher/database/SQLiteException;)V
    ...
    goto :goto_d
    :try_end_4
    .catch Lnet/sqlcipher/database/SQLiteException; {:try_start_4 .. :try_end_4} :catch_4

    :catch_4
    move-exception v6

    const-string v3, "c\u0003~|\tzm\ny\n\u000b\u0001\u000f"
    ...
    const-string v4, "\u0011.@.2h)f\u0019\u0016\u0010,6&\u00057!\",/#(&V-\u001d\u0019!Q\u0015\u0015\u001b\u0013!\u0011dI"
    ...
    invoke-static {v5, v6}, Lnet/sqlcipher/database/SqliteWrapper;->checkSQLiteException(Landroid/content/Context;Lnet/sqlcipher/database/SQLiteException;)V
    ...
    check-cast v2, Lnet/sqlcipher/database/SQLiteException;

    invoke-static {v2}, Lnet/sqlcipher/database/SqliteWrapper;->isLowMemory(Lnet/sqlcipher/database/SQLiteException;)Z
