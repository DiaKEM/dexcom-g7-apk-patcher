...
.annotation runtime Lkotlin/Metadata;
    bv = {}
    d1 = {
        "\u06fe\"h\u0701jczen\u0707pixkt\u070dvo\u0007qzszu~w\u0007\u0006\u0003{\u0003}\u0007\u007f\u0017\u0002\u000b\u0723\r\u0006\u001d\u0008\u0011\u0729\u0013\u000c#\u000e\u0017\u072f\u0019\u0012!\u001d\u001d\u0016\u001d\u0018!\u001a)\"%\u073d\' 7\"+\u0743=,5\u0747A,A+[-G<?2K4c7g<G<S<kAWTOF[DsGwLWLcL{Q\u007fT_WkT\u0004\\ofgas\\\u000cd\u0010doj{d\u0014o.h\u0002\tyv\u0006n\u001ey\"v\u0002v\u000ev&\u0004*~\n\t\u0016~.\u000e2\u0007\u0012\u0013\u001e\u00076\u0018P\u0010$3\u001c\u0019(\u0011@\u001cD\u0019$\u00190\u0019H&L!,+8!P0T)45@)X:\\3<?H3H2b4NCFJR;jOnCNTZCrY\u008cK]"
    }
    d2 = {
        ")9-*6(\u0007&,\"%-&\u001c0&EE+B9A5A",
        "\u0012(6-42-)l.3o|\u001c* ;CD:F<CC!87?+7\u0007",
        "*979\u000877\u00187-#\u0015,$#$;IK",
        "",
        "*)",
...
.method public static final createCancellationSignal()Landroid/os/CancellationSignal;
    ...
    invoke-static {v0, v1}, Landroidx/room/util/DBUtil;->ᫎ᫅᫗(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final query(Landroidx/room/RoomDatabase;Landroidx/sqlite/db/SupportSQLiteQuery;Z)Landroid/database/Cursor;
    ...
    .annotation runtime Lkotlin/Deprecated;
        message = "\u0015(,5d-:e867ClAB3\u0015O\u001c T(\u001f\u001bX\u001f (\". 2\u0006\u0004B\u0005\u0014\u0008\u000cE\n\u0016\u000fI \u0014\u001e#|s\u00018\t3xz8z{\u0006\t\u0001\u0003=dhtfgwr~6"
    .end annotation
    ...
    invoke-static {v0, v2}, Landroidx/room/util/DBUtil;->ᫎ᫅᫗(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs ᫎ᫅᫗(I[Ljava/lang/Object;)Ljava/lang/Object;
    .locals 15
    ...
    invoke-virtual {v11, v2}, Ljava/nio/channels/FileChannel;->read(Ljava/nio/ByteBuffer;)I
    ...
    const-string v10, "`\u0001\u0005A\u0007\u0005\u0019\u0007\t\t\u001c\u000fJ\u0014\u0012\u000f\u0013\u0015#]R)#\u0017\u0019$\u001eY/+\\0$!%avc\'?;-<i,@l=56D7Gs\u000b\u0006"
    ...
    const-string/jumbo v2, "}zXtzjY|gs}"
    ...
    invoke-virtual {v8, v7, v9}, Landroidx/room/RoomDatabase;->query(Landroidx/sqlite/db/SupportSQLiteQuery;Landroid/os/CancellationSignal;)Landroid/database/Cursor;

    move-result-object v3

    if-eqz v12, :cond_7

    instance-of v0, v3, Landroid/database/AbstractWindowedCursor;
    ...
    invoke-static {v5, v4, v6, v0}, Landroidx/room/util/DBUtil;->query(Landroidx/room/RoomDatabase;Landroidx/sqlite/db/SupportSQLiteQuery;ZLandroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    const-string v6, "s\u0003V;\u0012M5\t#\u0003\u0018!Y\\0{RF\u0011*:U{r:p\u0004xj7:wx\u0017B,/5"
    ...
    const-string v3, "?RPROS\u0010JIY9[ZRXR\u0014\u001f\u0017"
    ...
    :cond_d
    const-string v2, "#KD:6DrCC}CI?@@N*4;g7+20.B8?7=j0^iZggWeYa8\u001f"
    ...
    const-string v4, "6HMI=OCHF~I}s77E52B20j37g;.*c)1-,.5&*\"Y\u001c\'%))&\u0014\u001b\u001f$V!Ue4"
    ...
    const-string v4, "_\u0002^.v\u0014\u0002f*}1c(J d\u000e\u0017^b\u000e\\\n\u0012I-n3@\u007fQ\u0007\u0008"
    ...
    const-string v6, "p\u0011\u000e\u0004\u0008\u007fY\u000c~\u0001ww\u000488<n|{v\u00030i{npggsAbrfki#\'lfIif\\`X\u0018\u0018"
    ...
    const-string v5, "SVFMTI)pz~rwv~p}x\u000ety\u007f}|\u0006C|"
    ...
    :cond_17
    :try_start_5
    invoke-static {v2}, Landroidx/room/util/DBUtil;->processForeignKeyCheckFailure(Landroid/database/Cursor;)Ljava/lang/String;
    ...
    const-string/jumbo v5, "xiogdt?\r~\n\u0001:_jfc5\u0008\u0005~z\u0005tmzm~~nz\']MIUG!txnb\u001c8\u001a li_\\[Xd\u0018"
    ...
    invoke-interface {v8, v1}, Landroidx/sqlite/db/SupportSQLiteDatabase;->query(Ljava/lang/String;)Landroid/database/Cursor;
    ...
    const-string v5, "jhih[crr_dqqxjt{g|\u0004yol"
    ...
    invoke-static {v9, v0, v7, v10, v6}, Lkotlin/text/StringsKt;->startsWith$default(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    const-string v12, "Xeaa0c`VSRO[(PL%I[KTTR\u001e"
