...
.method public static isConfirmingDeviceCredential()Z
    ...
    invoke-static {v0, v1}, Landroidx/biometric/Utils;->ࡩ᫘ᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static isModelInPrefixList(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    invoke-static {v0, v2}, Landroidx/biometric/Utils;->ࡩ᫘ᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static launchDeviceCredentialConfirmation(Ljava/lang/String;Landroidx/fragment/app/FragmentActivity;Landroid/os/Bundle;Ljava/lang/Runnable;)V
    ...
    const-string v3, "A]fjdd!vr$hnlkt*oq\u0004wru1u\u0006yy{\u0006\r\u0003{\u0008J=n\u0001\u0013\u0007\u0011\u0018D\u000e\u0008\u0016\r\u0016\u0010\u001eL\u001c\u001e$P\u0018\")#\u001ad"
    ...
    const-string v4, "Pjuwki({\u00021w{sp{/^^rdYZ\u0018Ztfhhlqi`V\u0017\u000c6K^O\\ScX@O[QV?K{R7HwEWMP\u0011"
    ...
    invoke-virtual {p1, v3}, Landroidx/biometric/DeviceCredentialHandlerActivity;->handleDeviceCredentialResult(I)V
    ...
    :goto_7
    invoke-virtual {v6, v5, v0}, Landroid/app/KeyguardManager;->createConfirmDeviceCredentialIntent(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Landroid/content/Intent;

    move-result-object v2

    if-nez v2, :cond_c

    const-string v5, "Zt{}us.\u0002{+mqmjq%hhxjcd\u001e`n`^^fk_V`!\u00128_c\u000e[aWV\tQUZJRW\u0002GRNK|\'@S@M8H9\u0002"
    ...
    invoke-virtual {v1, v0}, Landroidx/biometric/DeviceCredentialHandlerBridge;->setConfirmingDeviceCredential(Z)V

    invoke-virtual {v1}, Landroidx/biometric/DeviceCredentialHandlerBridge;->startIgnoringReset()V
    ...
    invoke-virtual {p1, v2, v3}, Landroidx/activity/ComponentActivity;->startActivityForResult(Landroid/content/Intent;I)V
...
.method public static varargs ࡩ᫘ᫀ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v5, v4, v0}, Landroidx/biometric/Utils;->isVendorInList(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    invoke-static {v5, v3, v0}, Landroidx/biometric/Utils;->isModelInPrefixList(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    invoke-static {v3, v2, v0}, Landroidx/biometric/Utils;->isModelInPrefixList(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    instance-of v1, v2, Landroidx/biometric/DeviceCredentialHandlerActivity;
