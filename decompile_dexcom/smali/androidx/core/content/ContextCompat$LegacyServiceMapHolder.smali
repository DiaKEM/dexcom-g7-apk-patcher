...
.method public static constructor <clinit>()V
    ...
    sput-object v8, Landroidx/core/content/ContextCompat$LegacyServiceMapHolder;->SERVICES:Ljava/util/HashMap;

    const-class v7, Landroid/telephony/SubscriptionManager;

    const-string v3, "8*2,8199E,AD2D5E=EJ@GG9NAOTHCF"
    ...
    const-class v6, Landroid/hardware/camera2/CameraManager;
    ...
    const-class v9, Landroid/media/projection/MediaProjectionManager;

    const-string v3, "PIIOHGY\\ZVRQcY``"
    ...
    const-class v9, Landroid/media/session/MediaSessionManager;
    ...
    const-class v6, Landroid/view/accessibility/CaptioningManager;

    const-string v3, "QN\\_SXVPTL"
    ...
    const-class v6, Landroid/hardware/ConsumerIrManager;

    const-string v5, "\u0001a9{\u0011)g\u001e7W\u0008"
    ...
    const-class v6, Landroid/print/PrintManager;

    const-string v2, "P.tXM"
    ...
    const-class v6, Landroid/net/nsd/NsdManager;

    const-string v3, "8\u0010J6VW\u0007m \u0012p$\u0019OIw"
    ...
    const-string/jumbo v9, "w\u001dUM2iUnAV\u0005\u0011H"
    ...
    const-string v11, "]Qh]b`JSWNSGYIU"
    ...
    const-class v6, Landroid/nfc/NfcManager;
